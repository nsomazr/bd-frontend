...
export const translations = {
  en: {
    ...
    "sidebar.searchEmpty": "No chats matched your search.",
    "sidebar.searchFailed": "Search failed. Try again.",
    ...
    "chat.voiceInput": "Sukuma voice input",
    "chat.voiceHint": "Tap to record Sukuma speech. Tap the stop button when finished to transcribe.",
    "chat.voiceStop": "Stop recording and transcribe",
    "chat.voiceStopHint": "Stop recording — transcription runs after you finish speaking",
    "chat.voiceRecording": "Recording",
    "chat.voiceRecordingHint": "Tap stop when done · Esc to cancel",
    "chat.voiceRecordingShort": "Recording… tap stop to transcribe",
    "chat.voiceRecordingPlaceholder": "Speak now — tap the stop button when finished…",
    "chat.voiceProcessingPlaceholder": "Transcribing… you can type your next message",
    "chat.voiceCancel": "Cancel",
    "chat.voiceProcessing": "Transcribing speech…",
    "chat.voiceTranscriptReady":
      "Sukuma transcript added below. Edit if needed, then press Send.",
    "chat.voiceComingSoon":
      "Sukuma transcript ready. Full voice reply (translate → chat → Sukuma speech) is coming soon — you can edit the text below and send normally.",
    "chat.voiceEmpty": "No speech detected. Try recording again.",
    "chat.voiceFailed": "Voice transcription failed. Try again or type your message.",
    "chat.voiceMicDenied": "Microphone access was denied.",
    ...
    "chat.useKnowledge": "Documents",
    "chat.knowledgeHint": "Search your uploaded documents for relevant context before answering (auto-enabled when you have uploads)",
    "chat.knowledgeSearching": "Searching documents...",
    "chat.documentSources": "Document sources",
    ...
    "knowledge.title": "Knowledge documents",
    "knowledge.hint": "Upload text, office files, or images (.txt, .md, .pdf, .docx, .xlsx, .csv, .json, .html, .png, .jpg, …). Images are read with OCR. Enable Documents when chatting to ground answers in your files.",
    "knowledge.upload": "Upload file",
    "knowledge.loading": "Loading documents…",
    "knowledge.empty": "No documents uploaded yet.",
    "knowledge.loadFailed": "Could not load documents.",
    "knowledge.uploadFailed": "Upload failed.",
    "knowledge.deleteFailed": "Could not delete document.",
    "knowledge.delete": "Delete document",
    "knowledge.close": "Close",
    "knowledge.openPanel": "Manage documents",
    "knowledge.chunks": "chunks",
    "knowledge.statusReady": "Ready",
    "knowledge.statusProcessing": "Processing",
    "knowledge.statusFailed": "Failed",
    "knowledge.scopedToChat": "Showing documents for this chat plus global uploads.",
    "knowledge.expand": "Expand documents panel",
    "knowledge.collapse": "Collapse documents panel",
    "knowledge.usageSummary": "{count}/{maxFiles} files · {size}/{maxSize}",
    "knowledge.limitsHint": "Up to {maxFiles} files, {maxFile} each, {maxTotal} total per account.",
    "knowledge.fileTooLarge": "File exceeds the {max} limit.",
    "knowledge.fileLimitReached": "Maximum of {max} files reached. Delete one to upload more.",
    "knowledge.storageLimitReached": "Storage limit of {max} reached. Delete files to free space.",

    "models.chooseModel": "Choose a model",
    "models.select": "Select model",
    "models.variantInstruct": "Instruct (SFT)",
    "models.variantDpo": "DPO aligned",
    "models.instructOnly": "Instruct only",
    "models.noDpoYet": "No DPO version yet — using instruct weights.",
  ...
  sw: {
    ...
    "sidebar.searchPlaceholder": "Tafuta mazungumzo…",
    "sidebar.searchResults": "Matokeo",
    "sidebar.searching": "Inatafuta…",
    "sidebar.searchEmpty": "Hakuna mazungumzo yaliyolingana.",
    "sidebar.searchFailed": "Utafutaji umeshindwa. Jaribu tena.",
    "sidebar.clearSearch": "Futa utafutaji",
    ...
    "chat.send": "Tuma",
    "chat.stop": "Simamisha jibu",
    "chat.voiceInput": "Sauti ya Kisukuma",
    "chat.voiceHint": "Gusa kurekodi Kisukuma. Gusa kitufe cha kusimamisha ukimaliza ili kutafsiri.",
    "chat.voiceStop": "Simamisha kurekodi na kutafsiri",
    "chat.voiceStopHint": "Simamisha kurekodi — utafsiri hufanyika baada ya kumaliza kusema",
    "chat.voiceRecording": "Inarekodi",
    "chat.voiceRecordingHint": "Gusa simamisha ukimaliza · Esc kughairi",
    "chat.voiceRecordingShort": "Inarekodi… gusa simamisha kutafsiri",
    "chat.voiceRecordingPlaceholder": "Sema sasa — gusa kitufe cha kusimamisha ukimaliza…",
    "chat.voiceProcessingPlaceholder": "Inatafsiri… unaweza kuandika ujumbe unaofuata",
    "chat.voiceCancel": "Ghairi",
    "chat.voiceProcessing": "Inatafsiri sauti…",
    "chat.voiceTranscriptReady":
      "Nakala ya Kisukuma imeongezwa hapa chini. Hariri ikihitajika, kisha bonyeza Tuma.",
    "chat.voiceComingSoon":
      "Nakala ya Kisukuma iko tayari. Jibu kamili kwa sauti (tafsiri → mazungumzo → sauti ya Kisukuma) linakuja hivi karibuni — unaweza kuhariri maandishi hapa chini na kutuma kawaida.",
    "chat.voiceEmpty": "Hakuna sauti iliyogunduliwa. Jaribu kurekodi tena.",
    "chat.voiceFailed": "Utafsiri wa sauti umeshindwa. Jaribu tena au andika ujumbe wako.",
    "chat.voiceMicDenied": "Ruhusa ya kipaza sauti imekataliwa.",
    ...
    "chat.useKnowledge": "Nyaraka",
    "chat.knowledgeHint": "Tafuta katika nyaraka zako zilizopakiwa kabla ya kujibu",
    "chat.knowledgeSearching": "Inatafuta katika nyaraka...",
    "chat.documentSources": "Vyanzo vya nyaraka",
    "chat.sources": "Vyanzo",
    ...
    "knowledge.title": "Nyaraka za maarifa",
    "knowledge.hint": "Pakia maandishi, faili za ofisi, au picha (.txt, .md, .pdf, .docx, .xlsx, .csv, .json, .html, .png, .jpg, …). Picha husomwa kwa OCR. Washa Nyaraka unapozungumza ili kujibu kutoka kwenye faili zako.",
    "knowledge.upload": "Pakia faili",
    "knowledge.loading": "Inapakia nyaraka…",
    "knowledge.empty": "Hakuna nyaraka zilizopakiwa bado.",
    "knowledge.loadFailed": "Imeshindwa kupakia nyaraka.",
    "knowledge.uploadFailed": "Upakiaji umeshindwa.",
    "knowledge.deleteFailed": "Imeshindwa kufuta nyaraka.",
    "knowledge.delete": "Futa nyaraka",
    "knowledge.close": "Funga",
    "knowledge.openPanel": "Simamia nyaraka",
    "knowledge.chunks": "vipande",
    "knowledge.statusReady": "Tayari",
    "knowledge.statusProcessing": "Inachakatwa",
    "knowledge.statusFailed": "Imeshindwa",
    "knowledge.scopedToChat": "Inaonyesha nyaraka za mazungumzo haya pamoja na zilizopakiwa kwa jumla.",
    "knowledge.expand": "Panua paneli ya nyaraka",
    "knowledge.collapse": "Kunja paneli ya nyaraka",
    "knowledge.usageSummary": "faili {count}/{maxFiles} · {size}/{maxSize}",
    "knowledge.limitsHint": "Hadi faili {maxFiles}, kila moja {maxFile}, jumla {maxTotal} kwa akaunti.",
    "knowledge.fileTooLarge": "Faili imezidi kikomo cha {max}.",
    "knowledge.fileLimitReached": "Kikomo cha faili {max} kimefikiwa. Futa moja ili kupakia zaidi.",
    "knowledge.storageLimitReached": "Kikomo cha hifadhi {max} kimefikiwa. Futa faili ili kuongeza nafasi.",

    "models.chooseModel": "Chagua modeli",
    "models.select": "Chagua modeli",
    "models.variantInstruct": "Instruct (SFT)",
    "models.variantDpo": "DPO aligned",
    "models.instructOnly": "Instruct tu",
    "models.noDpoYet": "Hakuna toleo la DPO bado — inatumia uzito wa instruct.",
